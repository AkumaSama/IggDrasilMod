...
public class ResetSkillCommand extends CommandBase {
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		...
		if(target != null) {
			...
			cap.resetAttribute();
			sender.sendMessage(new TextComponentString("Skill de " + target.getName() + " à été reset."));
