...
public class GuiButtonGuild extends GuiButton {
	private static final ResourceLocation BUTTON = IDMReferences.texture.GUILDBUTTON;
	private static final ResourceLocation BUTTON_HOVER = IDMReferences.texture.GUILDBUTTONHOVER;
	
	public GuiButtonGuild(int buttonId, int x, int y, int width, int height) {
