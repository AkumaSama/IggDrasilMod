...
public class GuiButtonMount extends GuiButton {
	private static final ResourceLocation BUTTON = IDMReferences.texture.MOUNTBUTTON;
	private static final ResourceLocation BUTTON_HOVER = IDMReferences.texture.MOUNTBUTTONHOVER;
