package fr.augma.idm.client.gui.iggdrasil.skill.button;
...
public class GuiAddButton extends GuiButton {
	public static final ResourceLocation BUTTON = IDMReferences.texture.ADDBUTTON;
	public static final ResourceLocation BUTTON_HOVER = IDMReferences.texture.ADDBUTTONHOVER;

	public GuiAddButton(int buttonId, int x, int y, int width, int height) {
