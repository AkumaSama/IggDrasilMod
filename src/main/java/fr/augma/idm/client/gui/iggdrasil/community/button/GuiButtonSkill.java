...
public class GuiButtonSkill extends GuiButton {
	private static final ResourceLocation BUTTON = IDMReferences.texture.SKILLBUTTON;
	private static final ResourceLocation BUTTON_HOVER = IDMReferences.texture.SKILLBUTTONHOVER;
	
	public GuiButtonSkill(int buttonId, int x, int y, int width, int height) {
